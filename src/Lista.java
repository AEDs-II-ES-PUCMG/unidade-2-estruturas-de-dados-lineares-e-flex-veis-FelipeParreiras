...
public class Lista<E> implements Iterable<E> {
    ...
    public E buscarPor(Comparator<E> criterioDeBusca, E item) {
        ...
        while (criterioDeBusca.compare(item, atual.getItem()) == 0) {
    ...
    // Tarefa 2
    public double somarMultiplicacoes(Function<E, Double> extratorValor,
Function<E, Integer> extratorFator) {
        // TODO: Para cada elemento, extrair o valor e multiplicar pela quantidade,
        ...
        while (atual.getProximo() != ultimo) {
            E item = atual.getItem();
            somatorio = somatorio + (extratorValor.apply(item)*extratorFator.apply(item));
        }
        return somatorio;
    }
